...
We will not convert this data to numeric, since it is not intuitive to separate marital status into different levels. It is not reasonable to say that married is better than single, so we will leave this variable as categorical.
