...
gss_data <- read_csv("gss.csv") %>%
  select(feelings_life, marital_status, education, average_hours_worked, self_rated_health, income_family, income_respondent)
  group_by(gss, self_rated_health) %>% summarise()
```
