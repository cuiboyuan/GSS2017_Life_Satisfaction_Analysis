...
contrasts(gss_numeric$marriage) <- contr.treatment(6,base = 5) # set Single as the reference
model <- brm(formula = feelings_life ~ marriage + education + health + income_respondent + work_hours,
             data = gss_numeric,
             seed = 84)
```
...
marriage1             0.16      0.05     0.06     0.26 1.00     4634     3340
marriage2             0.52      0.04     0.43     0.60 1.00     4635     3196
marriage3             0.73      0.03     0.67     0.79 1.00     4095     3473
marriage4            -0.10      0.07    -0.25     0.04 1.00     5385     2927
marriage6             0.01      0.09    -0.16     0.18 1.00     6403     3262
