...
```
  ...
  The estimated value of $\beta$ can be found under column 'Estimates', where each value, from top to bottom, represents estimated value of $\beta_0,..\beta_9$, respectively.
